...
-- Schema NiceEvaluation
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `NiceEvaluation` DEFAULT CHARACTER SET utf8 ;
USE `NiceEvaluation` ;
...
CREATE TABLE IF NOT EXISTS `NiceEvaluation`.`Questao` (
  ...
  PRIMARY KEY (`idQuestao`, `Materia_nome`),
...
CREATE TABLE IF NOT EXISTS `NiceEvaluation`.`Questao_has_Tema` (
  ...
  PRIMARY KEY (`Questao_idQuestao`, `Questao_Materia_nome`, `Tema_nome`, `Tema_Materia_nome`),
  INDEX `fk_Questao_has_Tema_Tema1_idx` (`Tema_nome` ASC, `Tema_Materia_nome` ASC) VISIBLE,
  INDEX `fk_Questao_has_Tema_Questao1_idx` (`Questao_idQuestao` ASC, `Questao_Materia_nome` ASC) VISIBLE,
  CONSTRAINT `fk_Questao_has_Tema_Questao1`
    FOREIGN KEY (`Questao_idQuestao` , `Questao_Materia_nome`)
    REFERENCES `NiceEvaluation`.`Questao` (`idQuestao` , `Materia_nome`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
